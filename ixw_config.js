module.exports = {
	name: "sdv", 
	description : "NV web frontend project based on IXW",
	namespace: "SDV",
	version: "1.0",
...
//			margin:8, // margin for each images in spirit file, default is 8
	...
	release :{
//		jsUrl : "http://localhost/nv/_rel/js",
//		imagesUrl : "http://localhost/nv/_rel/img",
//		cssUrl : "http://localhost/nv/_rel/css"
	},
	...
	grunt : {
		...
		concat: {
			chrome : {
				src : ["src/lib/chrome.js"],
				dest : "_dist/js/chrome.js"
			},
			ixw :{
				src : ["src/lib/chrome.js","src/lib/ix.js", "src/lib/jquery-2.1.1.js", "src/lib/jquery.cookie.js",
				"src/lib/three.min.js", "src/bootstrap/js/bootstrap.js",
					"src/lib/highcharts.js","src/lib/echarts.common.min.js", "src/lib/ixw.js", "src/lib/ixwui.js"],
				dest : "_dist/js/ixw.js"
			},
			project :{
				src : [
					"src/ixw/lib/util.js","src/ixw/grid/model.js",
					"src/ixw/grid/nvcols.js","src/ixw/grid/grid.js","src/ixw/lib/fileBtn.js",
					"src/ixw/lib/dialog.js",
					"src/ixw/lib/inputbox.js","src/ixw/lib/tree.js","src/ixw/lib/const.js","src/ixw/lib/addIpBox.js",
					"src/ixw/grid/nvgrid.js","src/ixw/lib/nvcharts.js",

					"src/ixw/_entry/index.js","src/ixw/_err/index.js",

					"src/ixw/_service/serviceDialog.js",
					"src/ixw/_overview/overviewDialog.js","src/ixw/_overview/wave.js","src/ixw/_overview/index.js",
					"src/ixw/_service/index.js",
					"src/ixw/_product/productDialog.js","src/ixw/_product/index.js",
					"src/ixw/_operation/index.js","src/ixw/_log/index.js",
					"src/ixw/index.js"],
